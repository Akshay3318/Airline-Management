...
const TicketSearchPage = () => {
  ...
  const handleFlightSearch = async (e) => {
    ...
    if (formData.from == formData.to) {
      setSearchStatus("From and To destinations should not be same");
      return;
    }
    ...
    try {
      ...
      if (data.status === false) {
        ...
        setSearchedFlights([]);
        setSearchStatus("No flights found for the selected route on this date, Please try on some other date");
      } else {
